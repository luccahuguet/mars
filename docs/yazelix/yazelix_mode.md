...
`mars --yazelix -e <command> [args...]` runs Mars as a Mars terminal
...
- the default Wayland app id / X11 class becomes `mars`; the desktop wrapper also honors `MARS_APP_ID` for parent-owned launcher identity
