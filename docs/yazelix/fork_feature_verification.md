...
Mars Terminal's current `mars` fork adds on top of the Rio base commit
...
nix build .#mars-fast
tools/yazelix_event_mode_smoke.sh ./result_mars_fast_package
```
