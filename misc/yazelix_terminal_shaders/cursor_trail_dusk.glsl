// Generated by Yazelix with cursor glow = medium
...
// Generated Yazelix split cursor variant

const vec4 YAZELIX_CURSOR_COLOR_0 = vec4(0.118, 0.118, 0.184, 1.0);
const vec4 YAZELIX_CURSOR_COLOR_1 = vec4(0.914, 0.271, 0.376, 1.0);
const float DURATION = 0.24;
const float YAZELIX_SPLIT_HORIZONTAL = 0.0;
const float YAZELIX_SPLIT_BLEND = 1.0;
