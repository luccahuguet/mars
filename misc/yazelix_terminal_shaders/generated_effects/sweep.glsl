...
// cursor settings.glow = medium
// cursor settings.duration = 1.0

// -- CONFIGURATION ---
vec4 TRAIL_COLOR = vec4(0.000, 0.902, 1.000, 1.0); // can change to eg: vec4(0.2, 0.6, 1.0, 0.5);
const float DURATION = 0.2; // in seconds
const float TRAIL_LENGTH = 0.5;
const float BLUR = 2; // blur size in pixels (for antialiasing)
